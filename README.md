...
1. Open **Doctor → Export Diagnostics**
2. Upload the ZIP file via the secure upload link
3. Open a GitHub Issue
4. Include the diagnostics file name

Diagnostics files are generated locally and shared manually.
